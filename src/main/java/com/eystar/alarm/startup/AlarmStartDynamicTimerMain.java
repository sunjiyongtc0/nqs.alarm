...
import com.eystar.alarm.flatMap.DataNoStandardProcessFunction;
...
public class AlarmStartDynamicTimerMain {
    ...
    public static void main(String[] args)  throws Exception {
        ...
        ).assignTimestampsAndWatermarks(new BoundedOutOfOrdernessTimestampExtractor<AlarmMeta>(Time.seconds(1)) {
            @Override
        ...
        AlarmList.keyBy("alarm_id").process(new DataNoStandardProcessFunction()).print();
